                ...
                <div class="content">
                    ...
                    <form action="create.php" method="post">
                        ...
                        <div>
                            ...
                            <?php if (isset($company) && $company == 1): ?>
                                <label>
                        ...
                        <div>
                            ...
                            <select name="cname" class="text-input">
                                <option value=""></option>
                                <?php foreach ($companies as $key => $company): ?>
                                    <?php if (!empty($cname) && $cname == $company['cname'] ): ?>
                                        <option selected value="<?php echo $company['cname'] ?>"><?php echo $company['cname'] ?></option>
                                    <?php else: ?>
